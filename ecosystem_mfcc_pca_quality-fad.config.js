...
module.exports = {
    apps : [
      ...
      { // see the `kromosynth-evaluate` repository: https://github.com/synth-is/kromosynth-evaluate
        ...
        args: "--host 127.0.0.1 --dimensions 2 --dimension-cells 10",
        instances : 3,
        exec_mode : "fork",
      ...
      ,
      {
        ...
        args: "evolution-runs --max-old-space-size=4096 --evolution-runs-config-json-file /Users/bjornpjo/Developer/apps/kromosynth-cli/cli-app/conf/evolution-runs_quality-fad.jsonc",
        instances : 1,
        // exec_mode : "fork",
