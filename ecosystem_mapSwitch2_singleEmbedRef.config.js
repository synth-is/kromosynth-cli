module.exports = {
  apps : [
    ...
    ,
    {
      ...
      args: "evolution-runs --max-old-space-size=4096 --evolution-runs-config-json-file /Users/bjornpjo/Developer/apps/kromosynth-cli/cli-app/conf/evolution-runs_map-switch2.jsonc",
      instances : 1,
      // exec_mode : "fork",
      max_memory_restart: '4G',
      cron_restart: '0 * * * *' // every * hours
