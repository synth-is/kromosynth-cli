...
#SBATCH --output=/fp/projects01/ec12/bthj/kromosynth/slurm-output/kromosynth-conf-duration_delta_pitch_combinations-singleCellWin_runIdx_${RUN_IDX}_iter_${ITERATION_IDX}-${iteration}.out
#SBATCH --ntasks=18
...
for ((i=1; i<=16; i++)); do
  ...
  rm /fp/projects01/ec12/bthj/kromosynth/gRPC-hosts/grpc-conf-duration_delta_pitch_combinations-singleCellWin-host-${RUN_IDX}-${ITERATION_IDX}-\$i
