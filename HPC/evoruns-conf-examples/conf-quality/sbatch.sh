...
for ((i=1; i<=${features_server_count}; i++)); do
  ...
  apptainer exec --mount 'type=bind,source=/home/bthj,destination=/home/bthj' --env PYTHONPATH=$PYTHONPATH:/home/bthj/kromosynth-evaluate /home/bthj/kromosynth-runner-python-CPU.sif python ${features_script} --host-info-file /home/bthj/gRPC-hosts/evaluation-feature-socket-${file_name}-host-\$i &
...
for ((i=1; i<=${quality_server_count}; i++)); do
  ...
  apptainer exec --mount 'type=bind,source=/home/bthj,destination=/home/bthj' --env PYTHONPATH=$PYTHONPATH:/home/bthj/kromosynth-evaluate /home/bthj/kromosynth-runner-python-CPU.sif python ${quality_script} --host-info-file /home/bthj/gRPC-hosts/evaluation-quality-socket-${file_name}-host-\$i &
...
for ((i=1; i<=${projection_server_count}; i++)); do
  ...
  apptainer exec --mount 'type=bind,source=/home/bthj,destination=/home/bthj' --env PYTHONPATH=$PYTHONPATH:/home/bthj/kromosynth-evaluate /home/bthj/kromosynth-runner-python-CPU.sif python ${projection_script} --host-info-file /home/bthj/gRPC-hosts/evaluation-projection-socket-${file_name}-host-\$i  &
