...
cd /fp/projects01/ec29/bthj/gpu/kromosynth-cli/gRPC/
...
cd /fp/projects01/ec29/bthj/gpu/kromosynth-cli/cli-app/
apptainer exec --nv --mount 'type=bind,source=/fp/projects01,destination=/fp/projects01' /fp/projects01/ec29/bthj/kromosynth-runner.sif node kromosynth.js evolution-runs --evolution-runs-config-json-file ${config_file_path} --max-old-space-size=4096 &
