...
QUALITY_SCRIPT="/fp/projects01/ec29/bthj/kromosynth-evaluate/evaluation/unsupervised/quality_mood.py --sample-rate 16000 --quality-methods 'mood_acoustic' --models-path '/fp/projects01/ec29/bthj/kromosynth-evaluate/measurements/models'"
