...
QUALITY_SCRIPT="/fp/projects01/ec29/bthj/kromosynth-evaluate/evaluation/unsupervised/quality_mood.py --sample-rate 16000 --quality-methods 'mood_aggressive,mood_happy,mood_party,mood_relaxed,mood_sad,mood_acoustic,mood_electronic' --models-path '/localscratch/<job-ID>/models'"
