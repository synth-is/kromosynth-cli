...
#SBATCH --account=ec12
#SBATCH --job-name=kromosynth-conf-duration_delta_pitch_combinations-singleCellWin_runIdx_${RUN_IDX}_iter_${ITERATION_IDX}
#SBATCH --output=/fp/projects01/ec29/bthj/slurm-output/kromosynth-conf-duration_delta_pitch_combinations-singleCellWin_runIdx_${RUN_IDX}_iter_${ITERATION_IDX}-${iteration}.out
#SBATCH --ntasks=18
