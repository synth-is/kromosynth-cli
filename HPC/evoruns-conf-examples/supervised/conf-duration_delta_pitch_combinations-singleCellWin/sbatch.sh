...
#SBATCH --output=/fp/projects01/ec29/bthj/slurm-output/kromosynth-conf-duration_delta_pitch_combinations-singleCellWin-${iteration}.out
#SBATCH --ntasks=18
...
for ((i=1; i<=16; i++)); do
  ...
  rm /fp/projects01/ec29/bthj/gRPC-hosts/grpc-conf-duration_delta_pitch_combinations-singleCellWin-host-\$i
