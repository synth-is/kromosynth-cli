...
#SBATCH --account=ec12
#SBATCH --job-name=kromosynth-conf-static_mutation_rate_combinations_-_delete_rates-singleCellWin
#SBATCH --output=/fp/projects01/ec29/bthj/slurm-output/kromosynth-conf-static_mutation_rate_combinations_-_delete_rates-singleCellWin-${iteration}.out
#SBATCH --ntasks=18
...
for ((i=1; i<=16; i++)); do
  ...
  rm /fp/projects01/ec29/bthj/gRPC-hosts/grpc-conf-static_mutation_rate_combinations_-_delete_rates-singleCellWin-host-\$i
