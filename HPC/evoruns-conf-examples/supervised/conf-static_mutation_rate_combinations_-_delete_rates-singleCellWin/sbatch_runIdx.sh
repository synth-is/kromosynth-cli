...
#SBATCH --account=$3
#SBATCH --job-name=kromosynth-conf-static_mutation_rate_combinations_-_delete_rates-singleCellWin_runIdx_${RUN_IDX}_iter_${ITERATION_IDX}
#SBATCH --output=/fp/projects01/ec29/bthj/slurm-output/kromosynth-conf-static_mutation_rate_combinations_-_delete_rates-singleCellWin_runIdx_${RUN_IDX}_iter_${ITERATION_IDX}-${iteration}.out
#SBATCH --ntasks=18
