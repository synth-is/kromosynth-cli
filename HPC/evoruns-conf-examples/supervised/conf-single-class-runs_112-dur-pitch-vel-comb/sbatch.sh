...
#SBATCH --account=ec29
#SBATCH --job-name=kromosynth-conf-single-class-runs_112-dur-pitch-vel-comb
#SBATCH --output=/fp/projects01/ec29/bthj/slurm-output/kromosynth-conf-single-class-runs_112-dur-pitch-vel-comb-${iteration}.out
#SBATCH --ntasks=18
...
apptainer exec --nv --mount 'type=bind,source=/fp/projects01,destination=/fp/projects01' /fp/projects01/ec29/bthj/kromosynth-runner.sif node kromosynth.js evolution-runs --evolution-runs-config-json-file /fp/projects01/ec29/bthj/QD/conf-single-class-runs_112-dur-pitch-vel-comb/evolution-runs.jsonc
