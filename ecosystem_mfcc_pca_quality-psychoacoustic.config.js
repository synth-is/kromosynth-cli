...
module.exports = {
    apps : [
      ...
      { // see the `kromosynth-evaluate` repository: https://github.com/synth-is/kromosynth-evaluate
        ...
        args: "--host 127.0.0.1 --sample-rate 48000",
        instances : 3,
        exec_mode : "fork",
        max_memory_restart: '700M',
        // cron_restart: '*/30 * * * *',
      ...
      ,
      { // see the `kromosynth-evaluate` repository: https://github.com/synth-is/kromosynth-evaluate
        name   : "kromosynth-evaluation-socket-server_quality-psychoacoustic",
        interpreter: '/Users/bjornpjo/Developer/apps/kromosynth-evaluate/evaluation/unsupervised/env/bin/python3',
        cwd: '/Users/bjornpjo/Developer/apps/kromosynth-evaluate/evaluation/unsupervised',
        script : "quality_psychoacoustic.py",
        args: "--host 127.0.0.1 --sample-rate 48000 --quality-methods 'roughness_median'",
        instances : 3,
        exec_mode : "fork",
        max_memory_restart: '700M',
        // cron_restart: '*/30 * * * *',
